export class Listing {
    ...
    constructor(listingID: number, listingHostID: number, listingClientID: number, listingName: string, listingDescription: string,
        listingPrice: string, listingStart: string, listingEnd: string, listingImgURL: string) {
